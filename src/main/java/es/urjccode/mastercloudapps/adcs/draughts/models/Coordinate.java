...
public class Coordinate {
	...
	List<Coordinate> betweenDiagonalList(Coordinate coordinate) {
		assert coordinate != null;

		List<Coordinate> diagonalList = new ArrayList<>();
		...
		Coordinate followingDiagonal = new Coordinate(this.row + rowShift, this.column + columnShift);

		if (this.diagonalDistance(coordinate) > 2) {
			diagonalList = followingDiagonal.betweenDiagonalList(coordinate);
		}

		diagonalList.add(followingDiagonal);
