...
public class GameView extends WithConsoleView {
	...
	private void findPieceColor(Controller controller, int row, int column) {
		Color color = controller.getColor(new Coordinate(row, column));
		if (color == null) {
